...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: TermsServiceWidget.routeName,
          path: TermsServiceWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => LocationSettingsWidget(),
        ),
        FFRoute(
          name: PetfriendlyPlacesWidget.routeName,
          path: PetfriendlyPlacesWidget.routePath,
          builder: (context, params) => PetfriendlyPlacesWidget(),
        ),
        FFRoute(
          name: CreatePawfileWidget.routeName,
          path: CreatePawfileWidget.routePath,
          builder: (context, params) => CreatePawfileWidget(),
        ),
        FFRoute(
          name: DetailedLocationWidget.routeName,
          path: DetailedLocationWidget.routePath,
          builder: (context, params) => DetailedLocationWidget(
        ...
        FFRoute(
          name: CommunityFeedScreenWidget.routeName,
          path: CommunityFeedScreenWidget.routePath,
          builder: (context, params) => CommunityFeedScreenWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: NearPawfileCardWidget.routeName,
          path: NearPawfileCardWidget.routePath,
          builder: (context, params) => NearPawfileCardWidget(
        ...
        FFRoute(
          ...
          path: PawfileDetailsWidget.routePath,
          builder: (context, params) => PawfileDetailsWidget(
            selectedDog: params.getParam(
              'selectedDog',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['pawfiles'],
        ...
        FFRoute(
          name: MyPawfilesWidget.routeName,
          path: MyPawfilesWidget.routePath,
          builder: (context, params) => MyPawfilesWidget(),
        ),
        FFRoute(
          name: PawfileWidget.routeName,
          path: PawfileWidget.routePath,
          asyncParams: {
            'selectedPawfile':
                getDoc(['pawfiles'], PawfilesRecord.fromSnapshot),
          },
          builder: (context, params) => PawfileWidget(
            selectedPawfile: params.getParam(
              'selectedPawfile',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: EditPawfileWidget.routeName,
          path: EditPawfileWidget.routePath,
          asyncParams: {
            'selectedPawfile':
                getDoc(['pawfiles'], PawfilesRecord.fromSnapshot),
          },
          builder: (context, params) => EditPawfileWidget(
            selectedPawfile: params.getParam(
              'selectedPawfile',
              ParamType.Document,
            ),
