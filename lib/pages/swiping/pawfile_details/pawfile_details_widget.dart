...
import 'pawfile_details_model.dart';
export 'pawfile_details_model.dart';

class PawfileDetailsWidget extends StatefulWidget {
  const PawfileDetailsWidget({
    super.key,
    required this.selectedDog,
    required this.fromUser,
  });

  final DocumentReference? selectedDog;

  /// reference to swiping user
  final DocumentReference? fromUser;

  static String routeName = 'PawfileDetails';
  static String routePath = '/pawfileDetails';

  @override
  State<PawfileDetailsWidget> createState() => _PawfileDetailsWidgetState();
}

class _PawfileDetailsWidgetState extends State<PawfileDetailsWidget> {
  late PawfileDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PawfileDetailsModel());
  }
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.network(
                                          columnPawfilesRecord.dogPhoto2,
                                          width: 200.0,
                                          height: 200.0,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.network(
                                          columnPawfilesRecord.dogPhoto3,
                                          width: 200.0,
                                          height: 200.0,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.network(
                                          columnPawfilesRecord.dogPhoto4,
                                          width: 200.0,
                                          height: 200.0,
                                          fit: BoxFit.cover,
                                        ),
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              StreamBuilder<List<SwipesRecord>>(
                                stream: querySwipesRecord(
                                  singleRecord: true,
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  ...
                                  List<SwipesRecord> containerSwipesRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final containerSwipesRecord =
                                      containerSwipesRecordList.isNotEmpty
                                          ? containerSwipesRecordList.first
                                          : null;
