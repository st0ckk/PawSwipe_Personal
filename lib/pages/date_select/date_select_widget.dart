...
class DateSelectWidget extends StatefulWidget {
  ...
  final DocumentReference? onwerRef;
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Builder(
                                    builder: (context) {
                                      if (_model.selectedDuration == '30 min') {
                                        return Padding(
                                          padding:
                                  ...
                                  Builder(
                                    builder: (context) {
                                      if (_model.selectedDuration == '1 hour') {
                                        return Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  12.0, 8.0, 12.0, 8.0),
                                        ...
                                        Builder(
                                          builder: (context) {
                                            if (_model.selectedTime != null) {
                                              return Text(
                                                '${dateTimeFormat("jm", _model.selectedTime)}-${_model.selectedDuration}',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
