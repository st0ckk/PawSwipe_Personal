...
import 'create_pawfile_model.dart';
export 'create_pawfile_model.dart';

class CreatePawfileWidget extends StatefulWidget {
  const CreatePawfileWidget({super.key});

  static String routeName = 'CreatePawfile';
  static String routePath = '/createPawfile';

  @override
  State<CreatePawfileWidget> createState() => _CreatePawfileWidgetState();
}

class _CreatePawfileWidgetState extends State<CreatePawfileWidget> {
  late CreatePawfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatePawfileModel());
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                borderColor: Color(0xFF1A1461),
                borderRadius: 12.0,
                borderWidth: 1.0,
                buttonSize: 40.0,
                fillColor: Color(0xFF1A1461),
                icon: Icon(
                  Icons.close_rounded,
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadDataUwl =
                                                                  true);
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadDataUwl =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_uploadDataUwl =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                          } else {
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadDataP9q =
                                                                  true);
                                                          var selectedUploadedFiles =
                                                              <FFUploadedFile>[];
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadDataP9q =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_uploadDataP9q =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                          } else {
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadDataMuc =
                                                                  true);
                                                          var selectedUploadedFiles =
                                                              <FFUploadedFile>[];
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadDataMuc =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_uploadDataMuc =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                          } else {
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadDataV85 =
                                                                  true);
                                                          var selectedUploadedFiles =
                                                              <FFUploadedFile>[];
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadDataV85 =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_uploadDataV85 =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                          } else {
                                      ...
                                      Container(
                                        ...
                                        child: Slider.adaptive(
                                          ...
                                          value: _model.distanceSliderValue ??=
                                              1.0,
                                          label: _model.distanceSliderValue
                                              ?.toStringAsFixed(0),
                                          divisions: 9,
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (_model.sizeValue == null) {
                          return;
                        }
                        if (_model.prefSizeValue == null) {
                          return;
                        }
                        ...
                        var confirmDialogResponse = await showDialog<bool>(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Confirm Create Pawfile'),
                                  content: Text(
                                      'Are you sure you want to create a pawfile with this information?'),
                                  actions: [
                                    TextButton(
