        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: StreamBuilder<List<CommunityPostsRecord>>(
                  stream: queryCommunityPostsRecord(
                    queryBuilder: (communityPostsRecord) =>
                        communityPostsRecord.where(
                      'category',
                      isEqualTo:
                          _model.searchText != '' ? _model.searchText : null,
                    ),
                  ),
                  builder: (context, snapshot) {
                    ...
                    List<CommunityPostsRecord>
                        listViewCommunityPostsRecordList = snapshot.data!;

                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      primary: false,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewCommunityPostsRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewCommunityPostsRecord =
                            listViewCommunityPostsRecordList[listViewIndex];
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            14.0, 5.0, 0.0, 10.0),
                                        child: Text(
                                          listViewCommunityPostsRecord.content,
