...
import 'schema/pawfiles_record.dart';
...
export 'schema/pawfiles_record.dart';
...
/// Functions to query PawfilesRecords (as a Stream and as a Future).
Future<int> queryPawfilesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PawfilesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PawfilesRecord>> queryPawfilesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PawfilesRecord.collection,
      PawfilesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PawfilesRecord>> queryPawfilesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
